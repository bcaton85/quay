...
setup(name='quay',
      ...
      packages=['features','auth','data','data.model','data.model.oci','util','util.security','util.metrics','image','image.docker', 'image.docker.schema2', 'image.shared','digest', 'oauth'],
